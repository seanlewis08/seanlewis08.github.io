...
**Why not just pick the "best" perturbation?** Because you don't know which one is best --- you don't know η₀. The union-then-filter approach avoids the selection problem entirely.
...
**It doesn't fix point estimation.** Perturbed DML improves *confidence intervals*, not the point estimate. Your β̂ is still the original DML estimate. If the nuisance is badly estimated, the point estimate is still biased --- you just get wider (honest) intervals that account for it.
