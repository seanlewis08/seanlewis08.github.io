...
- **LangChain Tools** (tool-calling framework): [github.com/langchain-ai/langchain](https://github.com/langchain-ai/langchain)
- **CrewAI** (multi-agent orchestration): [github.com/joaomdmoura/crewAI](https://github.com/joaomdmoura/crewAI)
- **XGBoost** (ML model used): [github.com/dmlc/xgboost](https://github.com/dmlc/xgboost)
- **FastAPI** (model serving): [github.com/tiangolo/fastapi](https://github.com/tiangolo/fastapi)

#### Further Reading

- [Tool Use with Claude](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) — Anthropic's tool-calling documentation
- [OpenAI Function Calling](https://platform.openai.com/docs/guides/function-calling) — OpenAI's tool use API
- [DSPy](https://github.com/stanfordnlp/dspy) — Programmatic LLM pipelines with tool integration
- [MLflow Model Serving](https://mlflow.org/docs/latest/models.html) — Production ML model deployment
